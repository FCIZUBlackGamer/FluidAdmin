...
public class CalendarView extends LinearLayout {
    ...
    private void initCalendarProperties(TypedArray typedArray) {
        ...
        mCalendarProperties.setHeaderColor(getResources().getDrawable(R.drawable.test));
    ...
    public void setSelectionLabelColor(int color) {
        Log.i("White Color", color+"");
        mCalendarProperties.setSelectionLabelColor(color);

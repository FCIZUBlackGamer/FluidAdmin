...
public class CalendarProperties {
    ...
    private int mCalendarType, mHeaderLabelColor, mSelectionColor, mTodayLabelColor, mTodayColor,
...
//        }
        ...
        return ContextCompat.getDrawable(mContext, R.drawable.test);
    }

    public void setHeaderColor(Drawable headerColor) {
    ...
    public int getSelectionLabelColor() {
        if (mSelectionLabelColor == 0 || mSelectionLabelColor == 16777215) {
    ...
    public void setSelectionLabelColor(int selectionLabelColor) {
        mSelectionLabelColor = 16777215;
        Log.i("White Color1", selectionLabelColor+"");
    }

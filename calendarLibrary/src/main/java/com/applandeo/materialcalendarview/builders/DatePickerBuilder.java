...
public class DatePickerBuilder {
     ...
     * @return The builder object to allow for chaining of methods
     * @deprecated Use {@link DatePickerBuilder#setHeaderColor(Drawable)}
     */
    @Deprecated
    public DatePickerBuilder headerColor(Drawable color) {
     ...
     * @return The builder object to allow for chaining of methods
     */
    public DatePickerBuilder setHeaderColor(Drawable color) {
